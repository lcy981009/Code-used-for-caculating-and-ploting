...
# 绘制第一张子图（第一行第一列）
ax = axs[0, 0]
ax.plot(df1.index,U_W, color=colors[0], marker=markers[0],markersize=6,  label = r"$\mathrm{\mathit{u}'{w}'}$")  # 绘制U_2，使用colors[0]颜色和markers[0]标记
ax.plot(df1.index,V_W, color=colors[1], marker=markers[1],markersize=5.5, label = r"$\mathrm{\mathit{v}'{w}'}$")  # 绘制V_2，使用colors[1]颜色和markers[1]标记
ax.plot(df1.index,u2, color=colors[3], marker=markers[2], markersize=8,label=r"$\mathrm{\mathit{{f}}_{*}}^{2}$")  # 绘制W_2，使用colors[2]颜色和markers[2]标记
...
ax.text(timestamp1, ax.get_ylim()[1]*0.25, '11:29:24.1', color='green', rotation=90, ha='right')#burn开始时间
ax.text(timestamp2, ax.get_ylim()[1]*0.25, '11:41:08.4', color='green', rotation=90, ha='right')#burn结束时间
...
ax.plot(df1.index,U_W, color=colors[0], marker=markers[0],markersize=6,  label = r"$\mathrm{\mathit{u}'{w}'}$")  # 绘制U_2，使用colors[0]颜色和markers[0]标记
ax.plot(df1.index,V_W, color=colors[1], marker=markers[1],markersize=5.5, label = r"$\mathrm{\mathit{v}'{w}'}$")  # 绘制V_2，使用colors[1]颜色和markers[1]标记
ax.plot(df1.index,u2, color=colors[3], marker=markers[2], markersize=8,label = r"$\mathrm{\mathit{U_*}^2}$")  # 绘制W_2，使用colors[2]颜色和markers[2]标记
...
ax.plot(df.index,U_W, color=colors[0], marker=markers[0],markersize=6,  label = r"$\mathrm{\mathit{u}'{w}'}$")  # 绘制U_2，使用colors[0]颜色和markers[0]标记
ax.plot(df.index,V_W, color=colors[1], marker=markers[1],markersize=5.5, label = r"$\mathrm{\mathit{v}'{w}'}$")  # 绘制V_2，使用colors[1]颜色和markers[1]标记
ax.plot(df.index,u2, color=colors[3], marker=markers[2], markersize=8,label = r"$\mathrm{\mathit{u_*}^2}$")  # 绘制W_2，使用colors[2]颜色和markers[2]标记
...
ax.plot(df.index,U_W, color=colors[0], marker=markers[0],markersize=6,  label = r"$\mathrm{\mathit{u}'{w}'}$")  # 绘制U_2，使用colors[0]颜色和markers[0]标记
ax.plot(df.index,V_W, color=colors[1], marker=markers[1],markersize=5.5, label = r"$\mathrm{\mathit{v}'{w}'}$")  # 绘制V_2，使用colors[1]颜色和markers[1]标记
ax.plot(df.index,u2, color=colors[3], marker=markers[2], markersize=8,label = r"$\mathrm{\mathit{u}*^2}}$")  # 绘制W_2，使用colors[2]颜色和markers[2]标记
...
axs[0,0].legend(prop={'size': 24},loc='upper center', bbox_to_anchor=(2, 1.3), shadow=True, ncol=4,handleheight=1.2)

fig.text(0.5,0.05,'TIMESTAMP',fontsize=24,ha='center')
fig.text(0.08,0.5,'Kinematic Momentum Flux(m²/s²)',fontsize=24,va='center',rotation='vertical')
fig.savefig('D:\\湍流数据\\风速数据\\RDS-2022-0081_Data\\Data\\SERDP_10x10_Sonic_Raw\\Burn02_Sonic\\绘图\\momentum_Burn02.png', dpi=600, bbox_inches='tight')
